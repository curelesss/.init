...

{
  ...
  # Enable VMware guest tool
  # correct display resolution
  # enable copy/past between host and guest vm
  virtualisation.vmware.guest.enable = true;

  # Ensure the right video drive is used, although the vmware guest tool might already setup the right drive
  # Enable the open-vm-tools with SVGA driver
